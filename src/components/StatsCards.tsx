import { Bird, Search, BarChart3, AlertTriangle } from "lucide-react";
...
export function StatsCards({ total, curios, canarios, nascidosAnoAtual, alertasCount }: StatsCardsProps) {
  const cards = [
    { label: "Total de Pássaros", value: total, icon: Bird, color: "text-primary" },
    { label: "Curiós", value: curios, icon: Search, color: "text-accent" },
